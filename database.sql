-- switching to database hmmasterdb
use hmmasterdb;
<<<<<<< HEAD
# truncating views and tables if exists
-- drop view crane;
-- drop view crane_view;
-- drop table csv_info;
-- drop table cut_info;
-- drop table machine_name_map;
-- drop table test;
-- drop table precalculations;
-- drop table operation_info;
-- drop table device_disconnected_info;
-- drop table smooth_data;
-- drop table smooth_data_rts;
-- drop table login;
-- drop table realTimeThresholds;
-- drop table web_app_parameters;
-- drop table hw_stats;
-- drop table machine_names;
-- drop table max_smooth_data;
-- drop table precalculations_crane;
=======
-- truncating views and tables if exists
drop view crane;
drop view crane_view;
